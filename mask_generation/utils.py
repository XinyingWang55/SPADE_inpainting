...
def RandomAttribute(mask=None, size=512):
    if mask==None:
        # mask=random.choices(['ThickStrokes', 'MediumStrokes', 'ThinStrokes','Every_N_Lines','Completion','Expand','Nearest_Neighbor'])[0]
        mask=random.choices(['ThickStrokes','MediumStrokes', 'ThinStrokes', \
            'Completion','Expand','Every_N_Lines','Nearest_Neighbor'])[0]
