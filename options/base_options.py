...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # for generator
        parser.add_argument('--netG', type=str, default='pix2pixhdspade', help='selects model to use for netG (pix2pixhd | spade | spadepix2pixhd)')
        ...
        parser.add_argument('--no_mask', action='store_true', help='specify it in training phase and will generate mask automatically')
